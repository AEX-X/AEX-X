...
<p align="center"><b>Distributed, censorship-resistant VPN platform</b></p>
<p>5 cooperating services: a Telegram-WebApp with a 3D globe, a FastAPI/JWT API, and an autonomous bot that SSH-deploys an Xray + HAProxy + nftables + nginx stack, generates VLESS/Reality profiles, and verifies every tunnel — down to a real phone on a mobile network. Per-IP-prefix reputation weeds out flaky nodes.</p>
<p align="center">
...
<p align="center"><b>Production Telegram sales funnel</b></p>
<p>Traffic-source tracking, a 6-step finite-state-machine application, an in-chat admin panel, click→application conversion analytics per channel, and automatic 1h / 24h re-engagement. Layered architecture, tests, CI, and ADRs documenting the key decisions.</p>
<p align="center">
  <img src="https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white" alt="Python"/>
