...
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=600&size=22&pause=1000&color=8B5CF6&center=true&vCenter=true&width=760&height=45&lines=Fullstack+builder+with+a+product+brain;Idea+to+deployed+MVP+-+solo;Backend%2C+frontend%2C+infra+-+I+own+it+end+to+end;Open+to+hackathon+teams+-+let's+build" alt="Typing tagline"/>
</p>

<p align="center">
  <img src="https://komarev.com/ghpvc/?username=AEX-302&label=Profile+views&color=8b5cf6&style=flat-square" alt="Profile views"/>
  &nbsp;
  <img src="https://img.shields.io/badge/Based%20in-Moscow%20(MSK)-0ea5e9?style=flat-square" alt="Location"/>
  &nbsp;
...
<p align="center">
<b>I take an idea to a working, deployed MVP on my own — backend, frontend, and infra.</b><br/>
Fullstack engineer with a product brain, based in Moscow.
</p>

- **Self-taught** — in about a year I went from zero to shipping a **distributed, censorship-resistant VPN platform**.
- I build **end-to-end**: backend, frontend, infra automation, and the product logic that makes a thing actually convert.
- Strong across **async Python + FastAPI**, **Telegram platforms** (bots & WebApps), **Docker / CI**, and **SSH-driven infra automation**.
- I treat AI as a **daily power tool** — shipping fast with OpenAI / Claude APIs and AI-assisted development.
- **Currently leveling up:** Cloud & DevOps — Kubernetes, CI/CD, observability.
- **Open to hackathon teams** — I can own the backend, the frontend, or ship a full MVP solo.
...
<p align="center"><b>AI in the loop</b></p>
<p align="center">
...
<p align="center">
<b>HAPP VPN</b> — a censorship-resistant platform built as five cooperating services: a Telegram-WebApp with a 3D globe, a FastAPI/JWT API, and an autonomous bot that SSH-deploys, stress-tests and self-heals a fleet of Xray/Reality servers — verified all the way down to a real phone on a mobile network.<br/>
<b>Funnel Bot</b> — a production Telegram sales funnel: source-tracked leads, in-chat admin panel, live conversion analytics, layered architecture, tests and CI.
</p>
...
<p align="center">
I'm looking for a hackathon team. I can take an MVP end-to-end, or own the backend or frontend.<br/>
Fast to ship, product-minded, and I sweat the details that make a demo actually work under the judges' hands.
</p>
